...
import javafx.scene.control.*;// importa todos los controles de JavaFX
...
public class IndexControlador implements Initializable {
    ...
    public void agregarTarea(){
        if (nombreTareaTexto.getText().isEmpty()){
            mostrarMensaje("Error en la validacion", "Debe proporcionar una tarea");
    ...
    public void eliminarTarea(){
        ...
        if (tarea != null){
            ...
            mostrarMensaje("Informacíón", "Tarea Eliminada: " + tarea.getIdTarea());
            limpiarFormulario();
            listarTareas();
        }
        else{
